...
export const COLLECTION_CARDS: CollectionCard[] = [
  // ===== 偉人 (15枚) =====
  { id: 'card-001', name: 'ダ・ヴィンチ', category: 'great_people', rarity: 'SR', description: '万能の天才。芸術家にして科学者、発明家。モナ・リザや最後の晩餐を描いた。', imageUrl: '/images/cards/card-001.webp' },
  { id: 'card-002', name: 'アインシュタイン', category: 'great_people', rarity: 'SR', description: '相対性理論を発表した天才物理学者。ノーベル物理学賞を受賞。', imageUrl: '/images/cards/card-002.webp' },
  { id: 'card-003', name: 'キュリー夫人', category: 'great_people', rarity: 'SR', description: '放射能の研究でノーベル賞を2度受賞した科学者。', imageUrl: '/images/cards/card-003.webp' },
  { id: 'card-004', name: 'ナポレオン', category: 'great_people', rarity: 'R', description: 'フランスの皇帝。ヨーロッパ中を征服した軍事の天才。', imageUrl: '/images/cards/card-004.webp' },
  { id: 'card-005', name: 'クレオパトラ', category: 'great_people', rarity: 'R', description: '古代エジプト最後の女王。知恵と美貌で国を守った。', imageUrl: '/images/cards/card-005.webp' },
  { id: 'card-006', name: '織田信長', category: 'great_people', rarity: 'R', description: '戦国時代の革命児。天下統一を目指した武将。', imageUrl: '/images/cards/card-006.webp' },
  ...
  { id: 'card-008', name: 'エジソン', category: 'great_people', rarity: 'R', description: '発明王。電球や蓄音機など1000以上の発明をした。', imageUrl: '/images/cards/card-008.webp' },
  ...
  { id: 'card-010', name: 'ガリレオ', category: 'great_people', rarity: 'R', description: '天文学の父。望遠鏡で天体を観測し、地動説を支持した。', imageUrl: '/images/cards/card-010.webp' },
  { id: 'card-011', name: 'モーツァルト', category: 'great_people', rarity: 'N', description: '神童と呼ばれた作曲家。5歳で作曲を始めた音楽の天才。', imageUrl: '/images/cards/card-011.webp' },
  ...
  { id: 'card-013', name: '野口英世', category: 'great_people', rarity: 'N', description: '細菌学者。黄熱病の研究に生涯を捧げた。千円札の肖像。', imageUrl: '/images/cards/card-013.webp' },
  ...
  { id: 'card-041', name: '電話', category: 'inventions', rarity: 'N', description: 'ベルが発明した通信機器。遠くの人と話せるようになった。', imageUrl: '/images/cards/card-041.webp' },
  ...
  { id: 'card-045', name: '火薬', category: 'inventions', rarity: 'N', description: '中国で発明された爆発物。花火や採掘にも使われる。', imageUrl: '/images/cards/card-045.webp' },
  ...
  { id: 'card-059', name: '豊臣秀吉', category: 'great_people', rarity: 'R', description: '天下統一を果たした武将。農民から関白にまで上り詰めた。', imageUrl: '/images/cards/card-059.webp' },
  ...
  { id: 'card-094', name: '紙', category: 'inventions', rarity: 'N', description: '中国四大発明の一つ。知識の記録と伝達を飛躍的に進歩させた。', imageUrl: '/images/cards/card-094.webp' },
  { id: 'card-095', name: '車輪', category: 'inventions', rarity: 'N', description: '文明の基礎。輸送と機械の発展を支えた人類最大の発明の一つ。', imageUrl: '/images/cards/card-095.webp' },
