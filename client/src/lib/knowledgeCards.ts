...
export const EFFECT_DEFS: Record<string, CardEffect> = {
  ...
  terracotta:      { id: 'terracotta',      name: '不滅の軍勢',       description: '公開時（任意発動）: ベンチの秦の兵士1枚をデッキトップに戻す。', category: 'bench' },
  qinshi:          { id: 'qinshi',          name: '天下統一',         description: '防御時、ベンチに万里の長城があれば防御+2。', category: 'def' },
