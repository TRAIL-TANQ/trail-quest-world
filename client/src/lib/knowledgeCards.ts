...
export const EFFECT_DEFS: Record<string, CardEffect> = {
  ...
  qinshi:          { id: 'qinshi',          name: '天下統一',         description: '防御時、ベンチに万里の長城があれば防御+2。公開時（任意発動）、ベンチの焚書坑儒をデッキトップに戻す。', category: 'def' },
  ...
  jeanne:          { id: 'jeanne',          name: 'オルレアンの乙女', description: '攻撃時ベンチに聖剣→攻撃+2、防御時ベンチに白百合の盾→防御+2。', category: 'special' },
