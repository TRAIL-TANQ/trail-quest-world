...
export const STARTER_DECKS: StarterDeck[] = [
  ...
  },
  {
    ...
    noiseCards: [],
    description: '聖剣と白百合の盾でジャンヌを強化。軍旗と聖女の旗印でサーチ、祈りの光で聖女ジャンヌが蘇る。火刑で相手を揺さぶり、信仰の戦術を貫く',
  },
  {
    id: 'starter-heritage',
    name: '始皇帝デッキ',
    icon: '🏛️',
    trumpCard: '始皇帝',
    // spec v7: 光合成 と 車輪 を外し、不老不死の薬 × 2 を追加。
    // 構成: 始皇帝(trump) + テーマ 14 = 15 枚
    themeCards: [
      '万里の長城',
      '紙', '紙', '紙',
      '秦の兵士', '秦の兵士', '秦の兵士',
    ...
    noiseCards: [],
    description: '紙と勅令で焚書坑儒を炸裂、除外から兵馬俑・不老不死の薬で蘇らせよ',
  },
  {
    id: 'starter-murasaki',
    name: '紫式部・清少納言デッキ',
