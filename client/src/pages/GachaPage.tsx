/*
 * GachaPage: Fantasy RPG gacha with rarity-based animation phases
        ...
        <div className="flex items-center justify-center" style={{ minHeight: '320px' }}>
          ...
          {phase === 'idle' && !pulledCard && (
            <div className="text-center">
              <div className="w-36 h-36 mx-auto mb-4 rounded-full flex items-center justify-center relative"
                style={{
                  background: 'linear-gradient(135deg, rgba(255,215,0,0.1), rgba(255,215,0,0.03))',
                  border: '2px solid rgba(255,215,0,0.3)', boxShadow: '0 0 24px rgba(255,215,0,0.1)',
                }}>
                <span className="text-7xl" style={{ animation: 'float 3s ease-in-out infinite' }}>🎰</span>
              </div>
              <p className="text-sm text-amber-200/50 mb-1">ガチャを回してカードをゲット！</p>
              <p className="text-[10px] text-amber-200/25">あと{pityRemaining}回で★5確定</p>
            </div>
          )}
          ...
          {phase === 'shake' && (
            <div className="text-center">
              <div className="w-36 h-36 mx-auto rounded-full flex items-center justify-center"
                style={{
                  background: 'linear-gradient(135deg, rgba(255,215,0,0.15), rgba(255,215,0,0.05))',
                  border: '2px solid rgba(255,215,0,0.5)', boxShadow: '0 0 32px rgba(255,215,0,0.2)',
              ...
              <div className="w-52 mx-auto rounded-2xl overflow-hidden relative"
                ...
                <div className="px-4 py-3 text-center" style={{ borderTop: `1px solid ${rarityColor}33` }}>
                  <div className="flex justify-center gap-0.5 mb-1.5">
                    {Array.from({ length: RARITY_STARS[pulledCard.rarity] || pulledCard.rarity }).map((_, i) => (
          ...
          <div className="space-y-3 mt-4">
            <button onClick={() => handlePull('normal')} disabled={user.currentAlt < GACHA_COSTS.NORMAL}
              ...
              <div className="flex items-center justify-between">
                <div className="text-left">
                  ...
                  <p className="text-[10px] text-amber-200/30">★1〜★4 カード</p>
                </div>
            ...
            <button onClick={() => handlePull('premium')} disabled={user.currentAlt < GACHA_COSTS.PREMIUM}
              ...
              style={{
                ...
                border: '1px solid rgba(255,215,0,0.3)', boxShadow: '0 0 16px rgba(255,215,0,0.05)',
              }}>
              <div className="flex items-center justify-between">
                <div className="text-left">
                  <p className="text-sm font-bold" style={{ color: '#ffd700' }}>プレミアムガチャ ×1</p>
                  <p className="text-[10px] text-amber-200/30">★3〜★6 確率UP！</p>
                </div>
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg"
