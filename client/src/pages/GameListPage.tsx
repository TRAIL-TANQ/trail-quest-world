    ...
    <div className="relative min-h-full">
      ...
      <div className="relative z-10 px-4 pt-4 pb-4">
        ...
        <div className="space-y-2.5">
          ...
          <div className="rounded-xl overflow-hidden opacity-40"
            style={{
              background: 'linear-gradient(135deg, rgba(21,29,59,0.6), rgba(14,20,45,0.6))',
              border: '1.5px solid rgba(255,255,255,0.08)',
            }}>
            <div className="flex items-center p-3 gap-3">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center text-2xl flex-shrink-0"
                style={{ background: 'rgba(255,255,255,0.03)', border: '1.5px solid rgba(255,255,255,0.08)' }}>🔮</div>
              <div className="flex-1 min-w-0">
                <h3 className="text-sm font-bold text-amber-200/30 truncate mb-0.5">Coming Soon...</h3>
                <p className="text-[11px] text-amber-200/20">新しいゲームを準備中です</p>
              </div>
            </div>
          </div>
        </div>
