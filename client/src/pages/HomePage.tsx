 ...
 * Rich ornate gold frames, decorative corner elements, glowing badges
 */
...
const categoryBgColors: Record<string, [string, string]> = {
  math: ['#f59e0b', '#d97706'],
  inquiry: ['#8b5cf6', '#7c3aed'],
  puzzle: ['#22c55e', '#16a34a'],
  japanese: ['#ec4899', '#db2777'],
  social: ['#ef4444', '#dc2626'],
        ...
        <div className="relative mb-5">
          ...
          <div className="text-center mb-3 relative">
            <div className="flex items-center justify-center gap-3 mb-1">
              ...
              <h1
                className="text-xl font-bold font-[var(--font-cinzel)] tracking-[0.15em]"
                style={{
                  color: '#ffd700',
          ...
          <div className="flex items-end gap-3">
            ...
            <div className="flex-1 mb-3">
              {/* Welcome card with ornate border */}
        ...
        <div className="mb-5">
          ...
          <div className="grid grid-cols-2 gap-2.5">
            {GAME_CATEGORIES.map((cat, i) => {
              const [c1, c2] = categoryBgColors[cat.id] || ['#666', '#555'];
              return (
