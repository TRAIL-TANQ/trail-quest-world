 ...
 * Keeps ALT earn effect integration from v2
 */
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden"
      ...
      {sparkles.map((s) => (
        <div key={s.id} className="absolute rounded-full"
          style={{
            width: s.size, height: s.size, background: '#ffd700',
      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="text-center mb-6">
          <div className="inline-block mb-4 px-6 py-2 rounded-xl relative"
            style={{
              ...
              border: '2px solid rgba(255,215,0,0.35)', boxShadow: '0 0 15px rgba(255,215,0,0.1)',
            }}>
          ...
          {isBest && showScore && (
            <div className="animate-bounce-in mb-3">
              <span className="text-xl font-bold"
                style={{ color: '#ffd700', textShadow: '0 0 20px rgba(255,215,0,0.6), 0 0 40px rgba(255,215,0,0.3)' }}>
                ベストスコア更新！
              </span>
            </div>
          )}
        ...
        {showDetails && (
          <div className="rounded-2xl p-4 mb-4 animate-slide-up relative"
            ...
            <div className="space-y-2.5 mb-4">
              ...
              {lastResult?.timeSeconds !== undefined && (
                <div className="flex items-center justify-between text-sm">
        ...
        {showDetails && (
          <div className="flex gap-3 animate-slide-up" style={{ animationDelay: '200ms' }}>
            ...
            <button onClick={() => navigate('/games')} className="rpg-btn rpg-btn-gold flex-1 py-3">もう一度プレイ</button>
          </div>
        )}
      </div>
    </div>
